...
if {[file isfile lzw_stream.autotvin.dat]} {
	file delete -force lzw_stream.autotvin.dat
}

if {[file isfile lzw_stream.autotvout.dat]} {
	file delete -force lzw_stream.autotvout.dat
}
