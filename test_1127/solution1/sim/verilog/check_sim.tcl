...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lzw_stream.autotvin_gmem.dat"
         "c.lzw_stream.autotvin_s1.dat"
         "c.lzw_stream.autotvin_length_r.dat"
         "c.lzw_stream.autotvin_file_buffer.dat"
         "c.lzw_stream.autotvin_total_bytes.dat"
         "c.lzw_stream.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lzw_stream.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
