...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lzw_stream.autotvin.dat"
	set constFileTvOut       "lzw_stream.autotvout.dat"
	set constFileHdlTvIn     "lzw_stream.autohdltvin.dat"
	set constFileHdlTvOut    "lzw_stream.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
