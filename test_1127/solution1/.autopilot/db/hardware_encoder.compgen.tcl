...
set id 11
set name lzw_stream_sitofp_32ns_32_4_no_dsp_1
...
set id 12
set name lzw_stream_fptrunc_64ns_32_2_no_dsp_1
...
set id 13
set name lzw_stream_fcmp_32ns_32ns_1_2_no_dsp_1
...
set id 15
set name lzw_stream_dmul_64ns_64ns_64_6_max_dsp_1
...
set id 16
set name lzw_stream_sitodp_32ns_64_4_no_dsp_1
...
# FIFO definition:
set ID 22
set FifoName lzw_stream_fifo_w8_d2_S
set InstName chr_stream_U
...
# FIFO definition:
set ID 23
set FifoName lzw_stream_fifo_w16_d2_S
set InstName cmprs_stream_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 24
set FifoName lzw_stream_fifo_w32_d2_S
set InstName cmprs_len_stream_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_file_buffer \
    op interface \
    ports { file_buffer { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_total_bytes \
    op interface \
    ports { total_bytes { I 64 vector } } \
} "
}
