...
`define AUTOTB_DUT      lzw_stream
`define AUTOTB_DUT_INST AESL_inst_lzw_stream
`define AUTOTB_TOP      apatb_lzw_stream_top
`define AUTOTB_LAT_RESULT_FILE "lzw_stream.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "lzw_stream.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_lzw_stream_top
...
`define AESL_DEPTH_file_buffer 1
`define AESL_DEPTH_total_bytes 1
`define AUTOTB_TVIN_gmem  "./c.lzw_stream.autotvin_gmem.dat"
`define AUTOTB_TVIN_s1  "./c.lzw_stream.autotvin_s1.dat"
`define AUTOTB_TVIN_length_r  "./c.lzw_stream.autotvin_length_r.dat"
`define AUTOTB_TVIN_file_buffer  "./c.lzw_stream.autotvin_file_buffer.dat"
`define AUTOTB_TVIN_total_bytes  "./c.lzw_stream.autotvin_total_bytes.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.lzw_stream.autotvin_gmem.dat"
`define AUTOTB_TVIN_s1_out_wrapc  "./rtl.lzw_stream.autotvin_s1.dat"
`define AUTOTB_TVIN_length_r_out_wrapc  "./rtl.lzw_stream.autotvin_length_r.dat"
`define AUTOTB_TVIN_file_buffer_out_wrapc  "./rtl.lzw_stream.autotvin_file_buffer.dat"
`define AUTOTB_TVIN_total_bytes_out_wrapc  "./rtl.lzw_stream.autotvin_total_bytes.dat"
`define AUTOTB_TVOUT_gmem  "./c.lzw_stream.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.lzw_stream.autotvout_gmem.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_file_buffer = 1;
parameter LENGTH_total_bytes = 1;
...
reg end_file_buffer;
reg [31:0] size_file_buffer;
reg [31:0] size_file_buffer_backup;
reg end_total_bytes;
reg [31:0] size_total_bytes;
reg [31:0] size_total_bytes_backup;
