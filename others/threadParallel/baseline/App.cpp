...
int main()
{
  ...
  extern stopwatch time_filter_horizontal;
  extern stopwatch time_filter_vertical;
  ...
  std::cout << "Total latency of Filter horizontal is: " << time_filter_horizontal.latency() << " ns." << std::endl;
  std::cout << "Total latency of Filter vertical is: " << time_filter_vertical.latency() << " ns." << std::endl;
  ...
  std::cout << "Average latency of Filter horizontal per loop iteration is: " << time_filter_horizontal.avg_latency() << " ns." << std::endl;
  std::cout << "Average latency of Filter vertical per loop iteration is: " << time_filter_vertical.avg_latency() << " ns." << std::endl;
