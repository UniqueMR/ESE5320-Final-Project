...
void XHardware_encoding_Set_length_r(XHardware_encoding *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHardware_encoding_WriteReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_LENGTH_R_DATA, Data);
}

u32 XHardware_encoding_Get_length_r(XHardware_encoding *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHardware_encoding_ReadReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_LENGTH_R_DATA);
    return Data;
}

void XHardware_encoding_Set_out_code(XHardware_encoding *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHardware_encoding_WriteReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_OUT_CODE_DATA, (u32)(Data));
    XHardware_encoding_WriteReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_OUT_CODE_DATA + 4, (u32)(Data >> 32));
}

u64 XHardware_encoding_Get_out_code(XHardware_encoding *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHardware_encoding_ReadReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_OUT_CODE_DATA);
    Data += (u64)XHardware_encoding_ReadReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_OUT_CODE_DATA + 4) << 32;
    return Data;
}

void XHardware_encoding_Set_header(XHardware_encoding *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHardware_encoding_WriteReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_HEADER_DATA, (u32)(Data));
    XHardware_encoding_WriteReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_HEADER_DATA + 4, (u32)(Data >> 32));
}

u64 XHardware_encoding_Get_header(XHardware_encoding *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHardware_encoding_ReadReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_HEADER_DATA);
    Data += (u64)XHardware_encoding_ReadReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_HEADER_DATA + 4) << 32;
    return Data;
}

void XHardware_encoding_Set_out_len(XHardware_encoding *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHardware_encoding_WriteReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_OUT_LEN_DATA, (u32)(Data));
    XHardware_encoding_WriteReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_OUT_LEN_DATA + 4, (u32)(Data >> 32));
}

u64 XHardware_encoding_Get_out_len(XHardware_encoding *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHardware_encoding_ReadReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_OUT_LEN_DATA);
    Data += (u64)XHardware_encoding_ReadReg(InstancePtr->Control_BaseAddress, XHARDWARE_ENCODING_CONTROL_ADDR_OUT_LEN_DATA + 4) << 32;
    return Data;
}
