...
proc create_root_design { parentCell } {
  ...
  # Create instance: hardware_encoding_1, and set properties
  ...
  connect_bd_intf_net -intf_net axi_ic_zynq_ultra_ps_e_0_M_AXI_HPM1_FPD_M00_AXI [get_bd_intf_pins axi_ic_zynq_ultra_ps_e_0_M_AXI_HPM1_FPD/M00_AXI] [get_bd_intf_pins hardware_encoding_1/s_axi_control]
  ...
  connect_bd_intf_net -intf_net hardware_encoding_1_m_axi_gmem [get_bd_intf_pins axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S00_AXI] [get_bd_intf_pins hardware_encoding_1/m_axi_gmem]
  ...
  connect_bd_net -net hardware_encoding_1_interrupt [get_bd_pins axi_intc_0_intr_1_interrupt_concat/In1] [get_bd_pins hardware_encoding_1/interrupt]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn1 [get_bd_pins hardware_encoding_1/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hardware_encoding_1/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hardware_encoding_1/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hardware_encoding_1/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
