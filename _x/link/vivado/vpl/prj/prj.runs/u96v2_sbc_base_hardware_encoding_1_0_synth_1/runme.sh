...
HD_PWD='/mnt/castor/seas_home/c/chen3xn/ese532_code/project_1127/ESE5320-Final-Project/_x/link/vivado/vpl/prj/prj.runs/u96v2_sbc_base_hardware_encoding_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u96v2_sbc_base_hardware_encoding_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u96v2_sbc_base_hardware_encoding_1_0.tcl
