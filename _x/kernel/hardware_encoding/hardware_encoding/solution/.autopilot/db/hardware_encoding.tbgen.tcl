...
set C_modelArgList {
	...
	{ out_code int 64 regular {axi_slave 0}  }
	{ header int 64 unused {axi_slave 0}  }
	{ out_len int 64 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "s1","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "s1","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "out_code","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "out_code","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "header","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "header","bundle": "control"},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]},{"cName": "out_len","cData": "int","bit_use": { "low": 0,"up": 0},"offset": { "type": "dynamic","port_name": "out_len","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "out_code", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":36}, "offset_end" : {"in":47}} , 
 	{ "Name" : "header", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":48}, "offset_end" : {"in":59}} , 
 	{ "Name" : "out_len", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":60}, "offset_end" : {"in":71}} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"Port" : [
			...
			{"Name" : "out_code", "Type" : "None", "Direction" : "I"},
			{"Name" : "header", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_len", "Type" : "None", "Direction" : "I"}]},
	...
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_assoc_lookup_fu_570", "Parent" : "0",
		"CDFG" : "assoc_lookup",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	hardware_encoding {
		gmem {Type IO LastRead 167 FirstWrite 162}
		s1 {Type I LastRead 0 FirstWrite -1}
		length_r {Type I LastRead 0 FirstWrite -1}
		out_code {Type I LastRead 0 FirstWrite -1}
		header {Type I LastRead -1 FirstWrite -1}
		out_len {Type I LastRead 0 FirstWrite -1}}
	assoc_lookup {
